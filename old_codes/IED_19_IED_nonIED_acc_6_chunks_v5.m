...
% for pt = 1:1
    ...
    NonIED_bhvr_msr = BankedTrials(nonIEDIndices);
    ...
    nonIEDtrials_bhvr_measure_mean(pt) = mean(NonIED_bhvr_msr); 
    ...
    % permutation test for BankedTrials:
    pValPreOnset1 = chiSquaredTest(IED_StackedChans_bhvr_msr_PreOnset1,NonIED_bhvr_msr);
    pValPreOnset2 = chiSquaredTest(IED_StackedChans_bhvr_msr_PreOnset2,NonIED_bhvr_msr);
    pValPostOnset = chiSquaredTest(IED_StackedChans_bhvr_msr_PostOnset,NonIED_bhvr_msr);
    pValPreResponse = chiSquaredTest(IED_StackedChans_bhvr_msr_PreResponse,NonIED_bhvr_msr);
    pValPostResponse = chiSquaredTest(IED_StackedChans_bhvr_msr_PostResponse,NonIED_bhvr_msr);
    pValPreOutcome = chiSquaredTest(IED_StackedChans_bhvr_msr_PreOutcome,NonIED_bhvr_msr); 

    if pValPreOnset1 < 0.05
        IEDtrials_bhvr_measure_mean(pt,PreOnset1) = mean(IED_StackedChans_bhvr_msr_PreOnset1);
    end

    if pValPreOnset2 < 0.05
        IEDtrials_bhvr_measure_mean(pt,PreOnset2) = mean(IED_StackedChans_bhvr_msr_PreOnset2);
    end


    if pValPostOnset < 0.05
        IEDtrials_bhvr_measure_mean(pt,PostOnset) = mean(IED_StackedChans_bhvr_msr_PostOnset);
    end


    if pValPreResponse < 0.05
        IEDtrials_bhvr_measure_mean(pt,PreResponse) = mean(IED_StackedChans_bhvr_msr_PreResponse);
    end
