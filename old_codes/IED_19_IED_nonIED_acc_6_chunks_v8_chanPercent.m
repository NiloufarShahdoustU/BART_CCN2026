...
figure('Units', 'normalized', 'Position', [0.1, 0.1, 0.3, 0.4], 'Visible', 'on'); 
...
figure('Units', 'normalized', 'Position', [0.1, 0, 0.8, 4]);
position1 = [0.3, 0.9, 0.5, 0.06];
position2 = [0.3, 0.78, 0.5, 0.06];
position3 = [0.3, 0.65, 0.5, 0.06];
position4 = [0.3, 0.5, 0.5, 0.06];
position5 = [0.3, 0.35, 0.5, 0.06];
position6 = [0.3, 0.2, 0.5, 0.06];
...
visibleIndices = ChanNumsPreOnset1 > threshold_2 & ChanNumsPercentPreOnset1 > threshold;
...
visibleIndices = ChanNumsPreOnset2 > threshold_2 & ChanNumsPercentPreOnset2 > threshold;
...
visibleIndices = ChanNumsPostOnset > threshold_2 & ChanNumsPercentPostOnset > threshold;
...
visibleIndices = ChanNumsPreResponse > threshold_2 & ChanNumsPercentPreResponse > threshold;
...
visibleIndices = ChanNumsPostResponse > threshold_2 & ChanNumsPercentPostResponse > threshold;
...
visibleIndices = ChanNumsPreOutcome > threshold_2 & ChanNumsPercentPreOutcome > threshold;
