...
% for pt = 1:1
    ...
    NonIED_bhvr_msr = ITs(nonIEDIndices);
    ...
    nonIEDtrials_bhvr_measure_mean(pt) = mean(NonIED_bhvr_msr)/mean(ITs); 
    ...
    pValPostResponse = permutationTest(IED_StackedChans_bhvr_msr_PostResponse,NonIED_bhvr_msr, NumberofPermutations);
    pValPreOutcome = permutationTest(IED_StackedChans_bhvr_msr_PreOutcome,NonIED_bhvr_msr, NumberofPermutations); 

    if pValPreOnset1 < 0.05
        IEDtrials_bhvr_measure_mean(pt,PreOnset1) = mean(IED_StackedChans_bhvr_msr_PreOnset1)/mean(ITs);
    end

    if pValPreOnset2 < 0.05
        IEDtrials_bhvr_measure_mean(pt,PreOnset2) = mean(IED_StackedChans_bhvr_msr_PreOnset2)/mean(ITs);
    end


    if pValPostOnset < 0.05
        IEDtrials_bhvr_measure_mean(pt,PostOnset) = mean(IED_StackedChans_bhvr_msr_PostOnset)/mean(ITs);
    end


    if pValPreResponse < 0.05
        IEDtrials_bhvr_measure_mean(pt,PreResponse) = mean(IED_StackedChans_bhvr_msr_PreResponse)/mean(ITs);
    end


    if pValPostResponse < 0.05
        IEDtrials_bhvr_measure_mean(pt,PostResponse) = mean(IED_StackedChans_bhvr_msr_PostResponse)/mean(ITs);
    end


    if pValPreOutcome < 0.05
        IEDtrials_bhvr_measure_mean(pt,PreOutcome) = mean(IED_StackedChans_bhvr_msr_PreOutcome)/mean(ITs);
    end
