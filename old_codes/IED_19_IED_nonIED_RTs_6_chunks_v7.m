 % this is exactly as v6, but I am using different dataset, nothing else is different
 % Elliot took a look at the sanitiy check result for this version and it was not good
 % it was the one with IED detection version 6 that has band pass filter 15-40
...
outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_19_IEDnonIED_bhvr_analysis\v7\';
