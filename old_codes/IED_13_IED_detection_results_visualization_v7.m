...
inputFolderName_IEDdata = '\\155.100.91.44\d\Data\Nill\BART\bad_chans_removed_IEDdata_LFPmat_6_chunks_IED_11_v8';
...
% for pt = 1:2
    ...
    if(~isempty(IEDChanTrial_indices))
       ...
       % save
        outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_13_sanity_check\IED_13_sanity_check_v7\preOnset1\';
    ...
    if(~isempty(IEDChanTrial_indices))
       ...
       % save
        outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_13_sanity_check\IED_13_sanity_check_v7\PreOnset2\';
        set(gcf, 'Units', 'inches');
        screenposition = get(gcf, 'Position');
        set(gcf, 'PaperPosition', [0 0 screenposition(3:4)], 'PaperSize', [screenposition(3:4)]);
        filename = string(ptID) + '_IED_detection_sanity_check';
    ...
    if(~isempty(IEDChanTrial_indices))
       ...
       % save
        outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_13_sanity_check\IED_13_sanity_check_v7\PostOnset\';
        set(gcf, 'Units', 'inches');
        screenposition = get(gcf, 'Position');
        set(gcf, 'PaperPosition', [0 0 screenposition(3:4)], 'PaperSize', [screenposition(3:4)]);
        filename = string(ptID) + '_IED_detection_sanity_check';
    ...
    if(~isempty(IEDChanTrial_indices))
       ...
       % save
        outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_13_sanity_check\IED_13_sanity_check_v7\PreResponse\';
        set(gcf, 'Units', 'inches');
        screenposition = get(gcf, 'Position');
        set(gcf, 'PaperPosition', [0 0 screenposition(3:4)], 'PaperSize', [screenposition(3:4)]);
        filename = string(ptID) + '_IED_detection_sanity_check';
 ...
 %% PostResponse
    ...
    if(~isempty(IEDChanTrial_indices))
       ...
       % save
        outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_13_sanity_check\IED_13_sanity_check_v7\PostResponse\';
        set(gcf, 'Units', 'inches');
        screenposition = get(gcf, 'Position');
        set(gcf, 'PaperPosition', [0 0 screenposition(3:4)], 'PaperSize', [screenposition(3:4)]);
        filename = string(ptID) + '_IED_detection_sanity_check';
    ...
    if(~isempty(IEDChanTrial_indices))
       ...
       % save
        outputFolderName = '\\155.100.91.44\d\Code\Nill\BART\IED\IED_13_sanity_check\IED_13_sanity_check_v7\PreOutcome\';
        set(gcf, 'Units', 'inches');
        screenposition = get(gcf, 'Position');
        set(gcf, 'PaperPosition', [0 0 screenposition(3:4)], 'PaperSize', [screenposition(3:4)]);
        filename = string(ptID) + '_IED_detection_sanity_check';
