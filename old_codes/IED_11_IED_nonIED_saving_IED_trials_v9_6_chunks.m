% this version is the same version as v8! but I am using version 7 of IED detection. 
% you need to go with the version 6 for now!!
...
outputFolderName = '\\155.100.91.44\d\Data\Nill\BART\bad_chans_removed_IEDdata_LFPmat_6_chunks_IED_11_v9\'; 
...
% for pt = 1:2
    ...
    for chz = 1:nChans
        ...
        IEDStruct = detectIEDs_single_array_v7(mySig,Fs);
